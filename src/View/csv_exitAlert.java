 ...
 * @author emilezimmer
 */
public class csv_exitAlert extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(csv_exitAlert.class.getName());

    /**
     * Creates new form exitAlert
     */
    public csv_exitAlert() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new csv_exitAlert().setVisible(true));
    }
